...
const ALLOWED_TRANSITIONS: Record<AgentSessionState, AgentSessionState[]> = {
  ...
  PRODUCT_SELECTED: ['PROPOSAL_READY', 'AWAITING_HUMAN_APPROVAL', 'PAYMENT_INITIATED', 'SPEAKING', 'IDLE'],
  PROPOSAL_READY: ['AWAITING_HUMAN_APPROVAL', 'PAYMENT_INITIATED', 'SPEAKING', 'IDLE'],
  AWAITING_HUMAN_APPROVAL: ['PAYMENT_INITIATED', 'SPEAKING', 'IDLE'],
  PAYMENT_INITIATED: ['VERIFYING', 'IDLE'],
  VERIFYING: ['CAPTURED', 'IDLE'],
  CAPTURED: ['IDLE'],
};
